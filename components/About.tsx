    ...
    <section id="sobre" className="py-24 bg-transparent relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="text-brand-blue font-bold tracking-widest uppercase text-sm mb-2 block">O Contexto</span>
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white uppercase mb-6 leading-tight">
              A Ideia do <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-glow">COMPRASEG</span>
            </h2>
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 border-2 border-brand-gold/30 rounded-full z-30 flex items-center justify-center backdrop-blur-sm">
                <div className="w-24 h-24 bg-tactical-midnight/80 rounded-full flex items-center justify-center border border-white/10">
                    <span className="font-display font-bold text-brand-gold text-xl text-center leading-none">
                        Foco<br/>Total
                    </span>
                </div>
            </div>
